...
export const METRICS = [
  { value: "10", label: "друзей уже поступили за границу с его помощью" },
...
export const ABOUT = {
  ...
  story: [
    "В 2022 году у него было несколько месяцев на то, на что обычно " +
      "закладывают год: собрать документы, выбрать программы, успеть к " +
      "дедлайнам. Было страшно, что ничего не успеет, — как и всем, кто " +
      "начинает этот путь.",
    "Он писал университетам напрямую, перерыл все доступные сайты и форумы, " +
    ...
    "За четыре года он помог поступить десяти своим друзьям. Мы не обещаем " +
      "«гарантированного поступления» — так честно не может обещать никто. " +
      "Мы ведём по самым простым, протоптанным дорогам и бережём вас от " +
      "ошибок, которые уже совершили сами.",
  ],
